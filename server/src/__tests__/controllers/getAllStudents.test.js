/*
- Verifies getAllStudentsController functionality by retrieving all students.
- Checks if correct database query is made and response matches expectations.
  Validates getAllStudentsController behavior, ensuring accurate retrieval
  of students and response.
*/

const pool = require("../../../db");
const {
  getAllStudentsController,
} = require("../../controllers/getAllStudents");
...
it("should send status code of 200 when all students are returned", async () => {
  ...
  expect(responseMock.json).toHaveBeenCalledWith(fakeStudents);
